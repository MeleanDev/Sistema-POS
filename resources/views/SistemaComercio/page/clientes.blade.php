        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <button onclick="crear()" class="btn bg-gradient-primary btn-sm pb-2 ms-4">Agregar Cliente</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text">Nombre Cliente (Obligatorio)</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="apellido" class="form-control-label">Apellido</label>
                                    <input type="text" class="form-control" id="apellido" minlength="3" maxlength="50"
                                        placeholder="Apellido Cliente" required />
                                    <small class="form-text">Apellido Cliente (Obligatorio)</small>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text">Cedula Cliente (Obligatorio)</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="correo" class="form-control-label">Correo</label>
                                    <input type="email" class="form-control" id="correo" placeholder="Correo Cliente">
                                    <small class="form-text">Correo Cliente (Opcional)</small>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    <script>
        ...
        // ACCIONES
        crear = function() {
            rutaAccion = "{{ route('clientes.crear') }}";
            accion = 1;
        ...
        editar = async function(id) {
            rutaAccion = "{{ route('clientes.editar') }}/" + id;
            accion = 2;
            try {
                $("#formulario").trigger("reset");
                datos = await consulta(id);
        ...
        eliminar = function(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('clientes.eliminar') }}/" + id,
                        method: "DELETE",
                        headers: {
                            'X-CSRF-TOKEN': token
                        },
